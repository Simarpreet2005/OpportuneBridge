...
const Footer = () => {
  return (
    <footer className="bg-white dark:bg-background border-t border-border py-8">
      <div className="page-container">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="text-xl font-bold">OpportuneBridge</h2>
            <p className="text-sm text-muted-foreground">© 2026 OpportuneBridge. All rights reserved.</p>
          </div>
