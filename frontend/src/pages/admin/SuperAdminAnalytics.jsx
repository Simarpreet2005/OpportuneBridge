...
const COLORS = ['#6B4FD6', '#B7A6F7', '#E3A5C9', '#F59E0B', '#10B981']
    ...
    <Card className="relative overflow-hidden border-0 shadow-lg">
        ...
        <CardContent className="p-6">
            <div className="flex items-center justify-between">
                ...
                <div className={`text-3xl p-3 rounded-full bg-background/50 shadow-md`}>
                    {icon}
                </div>
            </div>
        </CardContent>
    ...
    return (
        <div className='min-h-screen bg-background'>
            <div className='max-w-7xl mx-auto my-10 px-4 space-y-8'>
                <div>
                    <h1 className='text-4xl font-bold text-foreground mb-1'>System Analytics</h1>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
                    <Card className="shadow-lg border border-border bg-card">
                        <CardHeader className="pb-2">
                            <CardTitle className="text-lg font-semibold text-foreground">User Distribution</CardTitle>
                        </CardHeader>
                        <CardContent>
                    ...
                    <Card className="shadow-lg border border-border bg-card">
                        <CardHeader className="pb-2">
                            <CardTitle className="text-lg font-semibold text-foreground">Jobs & Activity</CardTitle>
                        </CardHeader>
                        <CardContent>
                            <ResponsiveContainer width="100%" height={280}>
